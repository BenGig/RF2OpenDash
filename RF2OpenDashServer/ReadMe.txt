========================================================================
    KONSOLENANWENDUNG: RF2OpenDashServer-Projektübersicht
========================================================================

Diese RF2OpenDashServer-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre RF2OpenDashServer-Anwendung besteht.


RF2OpenDashServer.vcxproj
...
RF2OpenDashServer.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen RF2OpenDashServer.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
